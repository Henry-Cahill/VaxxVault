...
{
   /// <summary>
   /// Contains tests for the MainRails class.
   /// </summary>
   public class MainRailsTests
   {
      ...
      /// <summary>
      /// Tests the HandleMenuChoice method of the MainRails class.
      /// </summary>
      /// <param name="mainChoice">The menu choice to handle.</param>
      ...
      {
         // Arrange
         var method = typeof(MainRails).GetMethod("HandleMenuChoice", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
         if (method == null)
         {
            throw new InvalidOperationException("HandleMenuChoice method not found.");
         }

         // Mock console input if necessary
         var consoleInput = new System.IO.StringReader(mainChoice);
         Console.SetIn(consoleInput);

         // Act
         var result = (bool?)method.Invoke(null, new object[] { mainChoice });
      ...
      /// <summary>
      /// Tests the DisplayCalculationsAndResults method of the MainRails class.
      /// </summary>
      [Fact]
      ...
      /// <summary>
      /// Tests the ConfirmExit method of the MainRails class.
      /// </summary>
      /// <param name="exitChoice">The exit choice to confirm.</param>
      /// <param name="expected">The expected result.</param>
      [Theory]
