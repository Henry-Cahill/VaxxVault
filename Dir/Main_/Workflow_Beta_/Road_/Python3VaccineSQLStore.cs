public static class Python3VaccineSQLStore
{
   ...
   //  Console.Out.Flush();  // Ensure the disclaimer is printed before waiting for input

   //_logger.LogInformation("Displaying menu to the user.");
   ...
   //"SELECT ID, XmlData.value('(/antigenSupportingData/series/seriesName)[1]', 'VARCHAR(100)') AS SeriesName FROM VaccineData";
