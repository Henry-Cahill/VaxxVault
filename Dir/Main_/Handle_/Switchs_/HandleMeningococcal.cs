using System;
using VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Meningococcal;
...
namespace VaxxVault_V0004.Dir.Main_.Handle_.Switchs_
{
   internal class HandleMeningococcal
   {
      ...
      // (Review, Drop, or Load) for handling meningococcal vaccine data.
         ...
         try
         {
            ...
            switch (choice)
            {
               ...
               case "Drop":
                  ...
                  await Vaccine_MeningococcalD.DeleteXmlDataInDatabase();
                  break;
               case "Load":
