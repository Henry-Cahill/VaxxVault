using System;
using VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Hib;
...
namespace VaxxVault_V0004.Dir.Main_.Handle_.Switchs_
{
   internal class HandleHib
   {
      ...
      // (Review, Drop, or Load) for handling Hib (Haemophilus influenzae type b) vaccine data.
         ...
         try
         {
            ...
            switch (choice)
            {
               ...
               case "load":
                  ...
                  VaccineHibLoader.InsertXmlDataIntoDatabase();
                  break;
               default:
