using System;
using VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Diphtheria;
...
namespace VaxxVault_V0004.Dir.Main_.Handle_.Switchs_
{
   internal class HandleDiphtheria
   {
      ...
      // (Review, Drop, or Load) for handling diphtheria vaccine data.
         ...
         try
         {
            ...
            switch (choice)
            {
               ...
               case "load":
                  ...
                  VaccineDiphtheriaLoader.InsertXmlDataIntoDatabase();
                  break;
               default:
