using System;
using VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Ebola;
...
namespace VaxxVault_V0004.Dir.Main_.Handle_.Switchs_
{
   internal class HandleEbola
   {
      ...
      // (Review, Drop, or Load) for handling Ebola vaccine data.
         ...
         try
         {
            ...
            switch (choice)
            {
               ...
               case "load":
                  ...
                  VaccineEbolaLoader.InsertXmlDataIntoDatabase();
                  break;
               default:
