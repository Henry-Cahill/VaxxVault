using System;
using VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.YF;
...
namespace VaxxVault_V0004.Dir.Main_.Handle_.Switchs_
{
   internal class HandleYF
   {
      ...
      // (Review, Drop, or Load) for handling yellow fever (YF) vaccine data.
         ...
         try
         {
            ...
            switch (choice)
            {
               ...
               case "Load":
                  ...
                  VaccineYFLoader.InsertXmlDataIntoDatabase();
                  break;
               default:
