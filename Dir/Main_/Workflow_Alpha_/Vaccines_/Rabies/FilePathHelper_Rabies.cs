...
namespace VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Rabies
{
   internal static class FilePathHelper_Rabies
   {
      private static IConfiguration? _configuration;

      static FilePathHelper_Rabies()
      {
         try
         {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Rabies).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Rabies\\appsettingRabies.json", optional: false, reloadOnChange: true);
