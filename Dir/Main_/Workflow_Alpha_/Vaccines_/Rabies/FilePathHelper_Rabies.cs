...
{
   /// <summary>
   /// Helper class to manage file paths for Rabies workflow.
   /// </summary>
   internal static class FilePathHelper_Rabies
   {
      ...
      /// <summary>
      /// Initializes the configuration from the appsettingRabies.json file.
      /// </summary>
            ...
            lock (_lock)
            {
               if (_configuration == null)
               {
                  _configuration = new ConfigurationBuilder()
                      ...
                      .AddJsonFile("appsettingRabies.json", optional: false, reloadOnChange: true)
                      .Build();
               }
            }
         }
