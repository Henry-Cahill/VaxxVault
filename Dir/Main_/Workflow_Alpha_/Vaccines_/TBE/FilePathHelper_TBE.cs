   ...
   internal static class FilePathHelper_TBE
   {
      ...
      static FilePathHelper_TBE()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_TBE).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\TBE\\appsettingTBE.json", optional: false, reloadOnChange: true);
