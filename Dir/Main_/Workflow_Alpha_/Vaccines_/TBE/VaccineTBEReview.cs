...
namespace VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.TBE
{
   internal class VaccineTBEReview
   {
      ...
      private static string? GetFilePath(string version)
      {
         ...
         {
            "4.60" => @"A:\New.New\VaxxVault\Import\Version 4.60 - 508\XML\AntigenSupportingData- TBE-508.xml",
            "4.59" => @"A:\New.New\VaxxVault\Import\Version 4.59 - 508\XML\AntigenSupportingData- TBE-508.xml",
            "4.58" => @"A:\New.New\VaxxVault\Import\Version 4.58 - 508\XML\AntigenSupportingData- TBE-508.xml",
            "4.57" => @"A:\New.New\VaxxVault\Import\Version 4.57 - 508\XML\AntigenSupportingData- TBE-508.xml",
            _ => null
         };
      }
