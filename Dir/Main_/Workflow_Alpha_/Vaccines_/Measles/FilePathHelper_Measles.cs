   ...
   internal static class FilePathHelper_Measles
   {
      ...
      static FilePathHelper_Measles()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Measles).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Measles\\appsettingMeasles.json", optional: false, reloadOnChange: true);
