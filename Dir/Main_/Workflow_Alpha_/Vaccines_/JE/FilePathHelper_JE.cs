   ...
   internal static class FilePathHelper_JE
   {
      ...
      static FilePathHelper_JE()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_JE).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\JE\\appsettingJE.json", optional: false, reloadOnChange: true);
