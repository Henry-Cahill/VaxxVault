   ...
   internal static class FilePathHelper_HepA
   {
      ...
      static FilePathHelper_HepA()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_HepA).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\HepA\\appsettingHepA.json", optional: false, reloadOnChange: true);
