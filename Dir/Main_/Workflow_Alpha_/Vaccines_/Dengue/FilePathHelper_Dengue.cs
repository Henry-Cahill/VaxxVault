   ...
   internal static class FilePathHelper_Dengue
   {
      ...
      static FilePathHelper_Dengue()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Dengue).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Dengue\\appsettingDengue.json", optional: false, reloadOnChange: true);
