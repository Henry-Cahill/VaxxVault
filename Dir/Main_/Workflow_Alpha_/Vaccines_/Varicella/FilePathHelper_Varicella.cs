   ...
   internal static class FilePathHelper_Varicella
   {
      ...
      static FilePathHelper_Varicella()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Varicella).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Varicella\\appsettingVaricella.json", optional: false, reloadOnChange: true);
