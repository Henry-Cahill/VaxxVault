   ...
   internal static class FilePathHelper_Ebola
   {
      ...
      static FilePathHelper_Ebola()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Ebola).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Ebola\\appsettingEbola.json", optional: false, reloadOnChange: true);
