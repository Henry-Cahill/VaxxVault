   ...
   internal static class FilePathHelper_MeningococcalB
   {
      ...
      static FilePathHelper_MeningococcalB()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_MeningococcalB).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Meningococcal B\\appsettingMeningococcalB.json", optional: false, reloadOnChange: true);
