...
{
   /// <summary>
   /// Helper class to manage file paths for RSV workflow.
   /// </summary>
   internal static class FilePathHelper_RSV
   {
      ...
      /// <summary>
      /// Initializes the configuration from the appsettingRSV.json file.
      /// </summary>
            ...
            lock (_lock)
            {
               if (_configuration == null)
               {
                  _configuration = new ConfigurationBuilder()
                      ...
                      .AddJsonFile("appsettingRSV.json", optional: false, reloadOnChange: true)
                      .Build();
               }
            }
         }
