   ...
   internal static class FilePathHelper_RSV
   {
      ...
      static FilePathHelper_RSV()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_RSV).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\RSV\\appsettingRSV.json", optional: false, reloadOnChange: true);
