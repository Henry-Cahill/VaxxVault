   ...
   internal static class FilePathHelper_Polio
   {
      ...
      static FilePathHelper_Polio()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Polio).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Polio\\appsettingPolio.json", optional: false, reloadOnChange: true);
