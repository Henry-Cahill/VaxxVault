   ...
   internal static class FilePathHelper_HPV
   {
      ...
      static FilePathHelper_HPV()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_HPV).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\HPV\\appsettingHPV.json", optional: false, reloadOnChange: true);
