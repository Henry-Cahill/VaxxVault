...
namespace VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Rotavirus
{
   internal static class FilePathHelper_Rotavirus
   {
      ...
      static FilePathHelper_Rotavirus()
      {
         try
         {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Rotavirus).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Rotavirus\\appsettingRotavirus.json", optional: false, reloadOnChange: true);
