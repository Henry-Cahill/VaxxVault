...
{
   /// <summary>
   /// Helper class to manage file paths for Rotavirus workflow.
   /// </summary>
   internal static class FilePathHelper_Rotavirus
   {
      ...
      /// <summary>
      /// Initializes the configuration from the appsettingRotavirus.json file.
      /// </summary>
            ...
            lock (_lock)
            {
               if (_configuration == null)
               {
                  _configuration = new ConfigurationBuilder()
                      ...
                      .AddJsonFile("appsettingRotavirus.json", optional: false, reloadOnChange: true)
                      .Build();
               }
            }
         }
