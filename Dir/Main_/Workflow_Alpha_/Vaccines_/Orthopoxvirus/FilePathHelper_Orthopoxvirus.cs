   ...
   internal static class FilePathHelper_Orthopoxvirus
   {
      ...
      static FilePathHelper_Orthopoxvirus()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Orthopoxvirus).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Orthopoxvirus\\appsettingOrthopoxvirus.json", optional: false, reloadOnChange: true);
