...
namespace VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Influenza
{
   internal static class FilePathHelper_Influenza
   {
      ...
      static FilePathHelper_Influenza()
      {
         try
         {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Influenza).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Influenza\\appsettingInfluenza.json", optional: false, reloadOnChange: true);
