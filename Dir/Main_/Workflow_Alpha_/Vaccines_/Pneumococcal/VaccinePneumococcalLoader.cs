...
{
   /// <summary>
   /// Class to handle the insertion of Pneumococcal vaccine data into the database.
   /// </summary>
   internal class VaccinePneumococcalLoader
   {
      ...
      public static void InsertXmlDataIntoDatabase()
      {
         ...
         try
         {
            FilePathHelper_Pneumococcal.EnsureConfigurationInitialized();
