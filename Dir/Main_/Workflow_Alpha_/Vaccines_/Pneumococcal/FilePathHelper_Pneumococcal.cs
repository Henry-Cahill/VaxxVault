...
namespace VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Pneumococcal
{
   internal static class FilePathHelper_Pneumococcal
   {
      ...
      static FilePathHelper_Pneumococcal()
      {
         try
         {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Pneumococcal).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Pneumococcal\\appsettingPneumococcal.json", optional: false, reloadOnChange: true);
