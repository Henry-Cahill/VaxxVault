   ...
   internal static class FilePathHelper_HepB
   {
      ...
      static FilePathHelper_HepB()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_HepB).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\HepB\\appsettingHepB.json", optional: false, reloadOnChange: true);
