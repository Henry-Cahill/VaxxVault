...
namespace VaxxVault_V0004.Dir.Main_.Workflow_Alpha_.Vaccines_.Meningococcal
{
   internal static class FilePathHelper_Meningococcal
   {
      private static IConfiguration? _configuration;

      static FilePathHelper_Meningococcal()
      {
         try
         {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Meningococcal).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Meningococcal\\appsettingMeningococcal.json", optional: false, reloadOnChange: true);
