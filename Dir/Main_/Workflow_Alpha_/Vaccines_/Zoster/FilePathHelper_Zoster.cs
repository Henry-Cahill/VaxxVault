   ...
   internal static class FilePathHelper_Zoster
   {
      ...
      static FilePathHelper_Zoster()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Zoster).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Zoster\\appsettingZoster.json", optional: false, reloadOnChange: true);
