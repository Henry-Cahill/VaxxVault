   ...
   internal static class FilePathHelper_Rubella
   {
      ...
      static FilePathHelper_Rubella()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Rubella).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Rubella\\appsettingRubella.json", optional: false, reloadOnChange: true);
