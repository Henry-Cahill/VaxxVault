   ...
   internal static class FilePathHelper_Tetanus
   {
      ...
      static FilePathHelper_Tetanus()
      {
         ...
         catch (Exception ex)
         {
            ...
            throw new TypeInitializationException(typeof(FilePathHelper_Tetanus).FullName, ex);
         }
      }
         ...
         if (_configuration == null)
         {
            try
            {
               var builder = new ConfigurationBuilder()
                   ...
                   .AddJsonFile("Vaccines_\\Tetanus\\appsettingTetanus.json", optional: false, reloadOnChange: true);
