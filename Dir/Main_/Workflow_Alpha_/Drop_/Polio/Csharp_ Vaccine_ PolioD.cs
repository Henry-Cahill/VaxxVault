...
namespace VaxxVault_V0003.Dir.Main_.Workflow_Alpha_.Drop_.Polio
{
   internal class Vaccine_PolioD
   {
      public static void DeleteXmlDataInDatabase()
      {
         ...
         try
         {
            ...
            SqlCommandExecutor_Polio.ExecuteSqlCommandAsync(connectionString, "DELETE FROM VaccineData WHERE Id = @Id;");
         }
         ...
         Console.WriteLine("Reminder: Please load another version of the Polio XML data before proceeding.");
      }
   }
}
