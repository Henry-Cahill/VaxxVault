...
namespace VaxxVault_V0003.Dir.Main_.Workflow_Alpha_.Drop_.Meningococcal
{
   internal class Vaccine_MeningococcalD
   {
      public static void DeleteXmlDataInDatabase()
      {
         ...
         try
         {
            ...
            SqlCommandExecutor_Meningococcal.ExecuteSqlCommandAsync(connectionString, "DELETE FROM VaccineData WHERE Id = @Id;");
         }
         ...
         Console.WriteLine("Reminder: Please load another version of the Meningococcal XML data before proceeding.");
      }
   }
}
