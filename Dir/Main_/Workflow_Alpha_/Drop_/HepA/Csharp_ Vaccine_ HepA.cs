...
namespace VaxxVault_V0003.Dir.Main_.Workflow_Alpha_.Drop_.HepA
{
   internal class Vaccine_HepAD
   {
      public static void DeleteXmlDataInDatabase()
      {
         ...
         try
         {
            ...
            SqlCommandExecutor_HepA.ExecuteSqlCommandAsync(connectionString, "DELETE FROM VaccineData WHERE Id = @Id;");
         }
         ...
         Console.WriteLine("Reminder: Please load another version of the HepA XML data before proceeding.");
      }
   }
}
