   ...
   internal class Vaccine_MumpsD
   {
      public static void DeleteXmlDataInDatabase()
      {
         ...
         try
         {
            ...
            SqlCommandExecutor_Mumps.ExecuteSqlCommandAsync(connectionString, "DELETE FROM VaccineData WHERE Id = @Id;");
         }
         ...
         Console.WriteLine("Reminder: Please load another version of the Mumps XML data before proceeding.");
      }
   }
}
