   ...
   internal class Vaccine_HepBD
   {
      public static void DeleteXmlDataInDatabase()
      {
         ...
         try
         {
            ...
            SqlCommandExecutor_HepB.ExecuteSqlCommandAsync(connectionString, "DELETE FROM VaccineData WHERE Id = @Id;");
         }
         ...
         Console.WriteLine("Reminder: Please load another version of the HepB XML data before proceeding.");
      }
   }
}
