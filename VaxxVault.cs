         ...
         while (keepRunning)
         {
            ...
            switch (Console.ReadLine())
            {
               ...
               case "3":
                  ...
                  Console.WriteLine("15. Fifteen Attributes");
                  Console.WriteLine("16. Sixteen Attributes");
                  Console.WriteLine("17. Seventeen Attributes");
                  Console.WriteLine("18. Eighteen Attributes\n");
